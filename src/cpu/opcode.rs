...
impl From<u16> for Opcode {
    fn from(instruction: u16) -> Self {
        ...
        match (instruction >> 12) as u8 {
            ...
            0x1 => Opcode::Jump(all_data),
            0x2 => Opcode::SubroutineCall(all_data),
            ...
            0x8 => match last_half_byte {
                    ...
                    0x6 => Opcode::ShiftRegisterLeft(second_half_byte, third_half_byte),
                    0x7 => Opcode::NegativeSubtractRegister(second_half_byte, third_half_byte),
                    0xE => Opcode::ShiftRegisterRight(second_half_byte, third_half_byte),
                    _ => Opcode::Unknown
                },
            0x9 => Opcode::SkipNotEqVal(second_half_byte, third_half_byte),
            0xA => Opcode::SetIndexRegister(all_data),
            0xB => Opcode::JumpOffset(all_data),
